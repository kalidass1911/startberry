...
{
	$logo = '<span class="site-title" title="' . $sitename . '" >Header</span>';
}
?>
<!DOCTYPE html>
...
?>">
	...
	<div class="body" id="top">
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
			<!-- Header -->
			<header class="header" role="banner" style="text-align:center;">
...
<?php
	...
	$resonse  = json_decode($json);

	   if($resonse)
		{
         $n = 3;
           foreach($resonse as $result)
           {
                  ...
                  $description = $result->Description;
                   ...
                   $Images = $result->Images;
                    if(isset($Images[0]->url) && !empty($Images[0]->url))
                    {
                      if($n%3==0){
 ...
 <div class="span4">
                    	...
                    	<img src="<?php echo $Images[0]->url; ?>" width="200px" height="200px"> 
                    	<br>
                    	<?php echo $title; ?>
                    	  <br>
                    	<?php echo $price.' €' ; ?> 
